...
//	Engine Path
	...
	public void testInstanceVariableChampionCurrentHPGetter() {
		try {
			...
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
			e.printStackTrace();
		}
	}
	...
	public void testInstanceVariableChampionCurrentHPGetterLogic() {
		...
		try {
			...
			try {
				...
				fail("Objects of type \"" + Class.forName(champInstance).getSimpleName() + "\" can be instantiated.");
			}

			testGetterLogic(c, "currentHP", randomMaxHP);
		} catch (InvocationTargetException e) {
			fail("The type \"Champion\" must implement the inherited abstract method Damageable.getCurrentHP().");
			e.printStackTrace();
		} catch (Exception e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
			e.printStackTrace();
	...
	public void testInstanceVariableChampionCurrentHPSetterLogicMax() {
		...
		try {
			...
			fail("The type \"Champion\" must implement the inherited abstract method Damageable.setCurrentHP(int).");
	...
	public void testInstanceVariableChampionCurrentHPSetterLogicZero() {
		...
		try {
			...
			fail(e.getClass().getName() + " occurred.");
			e.printStackTrace();
		} catch (InvocationTargetException e) {
			fail("The type \"Champion\" must implement the inherited abstract method Damageable.setCurrentHP(int).");
	...
	public void testInstanceVariableChampionLocationGetterLogic() {
		...
		try {
			...
			fail("The type \"Champion\" must implement the inherited abstract method Damageable.getLocation().");
			e.printStackTrace();
		} catch (Exception e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
			e.printStackTrace();
	...
	public void testCoverLocationGetterLogic() {
		...
		try {
			...
			fail("Objects of type \"Cover\" can be instantiated.");
			e.printStackTrace();
		} catch (InvocationTargetException e) {
			fail("The type \"Cover\" must implement the inherited abstract method Damageable.getLocation().");
			e.printStackTrace();
		} catch (Exception e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
			e.printStackTrace();
	...
	public void testCoverCurrentHPGetterLogic() {
		...
		try {
			...
			fail("The type \"Cover\" must implement the inherited abstract method Damageable.getCurrentHP().");
			e.printStackTrace();
		} catch (Exception e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
			e.printStackTrace();
	...
	public void testCoverCurrentHPSetterLogicGeneral() {
		...
		try {
			...
			fail("The type \"Cover\" must implement the inherited abstract method Damageable.setCurrentHP(int).");
			e.printStackTrace();
		} catch (Exception e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
			e.printStackTrace();
	...
	public void testClassIsAbstractEffect() {
		try {
			...
			fail("Package model.effects should contain a class called Effect.");
		}
	}
	...
	public void testApplyExistsInEmbrace() {
		try {
			...
			fail("Class \"Embrace\" should implement the method called \"apply\" that takes a Champion as a parameter.");
		} catch (SecurityException e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
		} catch (ClassNotFoundException e) {
			fail("Package model.effects should contain a class called Embrace.");
		}
	...
	public void testApplyExistsInPowerUp() {
		try {
			...
			fail("Class \"PowerUp\" should implement the method called \"apply\" that takes a Champion as a parameter.");
		} catch (SecurityException e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
		} catch (ClassNotFoundException e) {
			fail("Package model.effects should contain a class called PowerUp.");
		}
	}
	...
	public void testApplyExistsInDodge() {
		try {
			...
			fail("Class \"Dodge\" should implement the method called \"apply\" that takes a Champion as a parameter.");
		} catch (SecurityException e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
		} catch (ClassNotFoundException e) {
			fail("Package model.effects should contain a class called Dodge.");
		}
	}
	...
	public void testApplyExistsInSpeedUp() {
		try {
			...
			fail("Class \"SpeedUp\" should implement the method called \"apply\" that takes a Champion as a parameter.");
		} catch (SecurityException e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
		} catch (ClassNotFoundException e) {
			fail("Package model.effects should contain a class called SpeedUp.");
		}
	}
	...
	public void testApplyExistsInDisarm() {
		try {
			...
			fail("Class \"Disarm\" should implement the method called \"apply\" that takes a Champion as a parameter.");
		} catch (SecurityException e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
		} catch (ClassNotFoundException e) {
			fail("Package model.effects should contain a class called Disarm.");
		}
	}
	...
	public void testRemoveExistsInShield() {
		try {
			...
			fail("Class \"Shield\" should implement the method called \"remove\" that takes a Champion as a parameter.");
		} catch (SecurityException e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
		} catch (ClassNotFoundException e) {
			fail("Package model.effects should contain a class called Shield.");
		}
	}
	...
	public void testRemoveExistsInSilence() {
		try {
			...
			fail("Class \"Silence\" should implement the method called \"remove\" that takes a Champion as a parameter.");
		} catch (SecurityException e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
		} catch (ClassNotFoundException e) {
			fail("Package model.effects should contain a class called Silence.");
		}
	}
	...
	public void testRemoveExistsInRoot() {
		...
		try {
			...
			fail("Class \"Root\" should implement the method called \"remove\" that takes a Champion as a parameter.");
		} catch (SecurityException e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
		} catch (ClassNotFoundException e) {
			fail("Package model.effects should contain a class called Root.");
		}
	}
	...
	public void testRemoveExistsInShock() {
		try {
			...
			fail("Class \"Shock\" should implement the method called \"remove\" that takes a Champion as a parameter.");
		} catch (SecurityException e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
		} catch (ClassNotFoundException e) {
			fail("Package model.effects should contain a class called Shock.");
		}
	}
	...
	public void testRemoveExistsInStun() {
		try {
			...
			fail("Class \"Stun\" should implement the method called \"remove\" that takes a Champion as a parameter.");
		} catch (SecurityException e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
		} catch (ClassNotFoundException e) {
			fail("Package model.effects should contain a class called Stun.");
		}
	}
	...
	public void applyLogicEmbraceNoChange() {
		...
		try {
			...
			assertNull("The method \"" + "apply" + "\" in class \"" + embraceObject.getClass().getSimpleName()
					+ "\" should not change \"" + "location" + "\".", location.get(championObject));

		} catch (NoSuchMethodException | NoSuchFieldException | IllegalArgumentException | IllegalAccessException |
				 ClassNotFoundException | SecurityException e) {
			fail(e.getClass().getName() + " occurred: " + e.getMessage());
			e.printStackTrace();
		} catch (InstantiationException e) {
			fail("Objects of type \"Embrace\" can be instantiated.");
		} catch (InvocationTargetException e) {
			fail("The type \"Embrace\" must implement the inherited abstract method Effect.apply(Champion).");
		}
	...
	public void applyLogicDisarmNoChange() {
		...
		try {
			...
			assertNull("The method \"" + "apply" + "\" in class \"" + disarmObject.getClass().getSimpleName()
					+ "\" should not change \"" + "location" + "\".", location.get(championObject));
			...
			fail("Objects of type \"Disarm\" can be instantiated.");
		} catch (InvocationTargetException e) {
			fail("The type \"Disarm\" must implement the inherited abstract method Effect.apply(Champion).");
		}
	...
	public void applyLogicDodgeNoChange() {
		...
		try {
			...
			assertNull("The method \"" + "apply" + "\" in class \"" + dodgeObject.getClass().getSimpleName()
					+ "\" should not change \"" + "location" + "\".", location.get(championObject));
			...
			fail("Objects of type \"Dodge\" can be instantiated.");
		} catch (InvocationTargetException e) {
			fail("The type \"Dodge\" must implement the inherited abstract method Effect.apply(Champion).");
		}
	...
	public void applyLogicPowerUpNoChange() {
		...
		try {
			...
			assertNull("The method \"" + "apply" + "\" in class \"" + powerObject.getClass().getSimpleName()
					+ "\" should not change \"" + "location" + "\".", location.get(championObject));
			...
			fail("Objects of type \"PowerUp\" can be instantiated.");
		} catch (InvocationTargetException e) {
			fail("The type \"PowerUp\" must implement the inherited abstract method Effect.apply(Champion).");
		}
	...
	public void applyLogicRootNoChange() {
		...
		try {
			...
			assertNull("The method \"" + "apply" + "\" in class \"" + rootObject.getClass().getSimpleName()
					+ "\" should not change \"" + "location" + "\".", location.get(championObject));
			...
			fail("Objects of type \"Root\" can be instantiated.");
		} catch (InvocationTargetException e) {
			fail("The type \"Root\" must implement the inherited abstract method Effect.apply(Champion).");
		}
	...
	public void applyLogicShieldBlockDmgAbilitySingleTarget() {
		...
		try {
			...
			try {
				...
				fail(e1.getCause() + " occurred while creating an instance of \"Player\".");
			}
			...
			try {
				...
				fail(e1.getCause() + " occurred while creating an instance of \"Game\".");
			}
			...
			try {
				try {
					...
					fail(e.getCause() + " occurred while creating an instance of \""
			...
			try {
				...
				fail(e1.getCause() + " occurred while invoking \"getBoard\" method on an instance of \"Game\".");
			...
			try {
				...
				fail("Objects of type \"Shield\" can be instantiated.");

			} catch (InvocationTargetException e) {
				fail(e.getCause() + " occurred while creating an instance of \"Shield\".");
			...
			try {
				...
				fail(e.getCause() + " occurred while creating an instance of \"PriorityQueue\".");
			...
			try {
				...
				fail(e1.getCause() + " occurred while creating an instance of \"DamagingAbility\".");
			...
			try {
				...
				fail(e.getCause() + " occurred while invoking \"getCurrentHP\" method on an instance of \""
			...
			try {
				...
				fail(e.getCause() + " occurred while invoking \"castAbility\" method on an instance of \"Game\".");
	...
	public void removeLogicSpeedUpActions() {
		...
		try {
			...
			fail("Objects of type \"SpeedUp\" can be instantiated.");
		} catch (InvocationTargetException e) {
			fail("The type \"SpeedUp\" must implement the inherited abstract method Effect.remove(Champion)");
		}
			...
			try {
				...
				try {
					...
					try {
						...
						assertNull("Board not updated correctly after champion moved UP.", boardGameUpdated[2][1]);
		...
		try {
			...
			try {
				...
				try {
					...
					if(size != 6) {
						assertEquals("Number of champions inside turnOrder priority queue after calling prepareChampionTurns is incorrect. Expected  " + 6 + " but was " + size + ".", 6, size);
					}
		...
		try {
			...
			try {
				...
				try {
					...
					assertEquals("The HP of the hero attacked by a hero is not updated correctly. Expected " + expectedHP + " but was " + newHP + ".", newHP, expectedHP);
		...
		try {
			...
			try {
				...
				try {
					...
					assertEquals("The HP of the antihero attacked by a hero is not updated correctly. Expected " + expectedHP + " but was " + newHP + ".", newHP, expectedHP);
		...
		try {
			...
			try {
				...
				try {
					...
					assertEquals("The HP of the villain attacked by a hero  is not updated correctly. Expected " + expectedHP + " but was " + newHP + ".", newHP, expectedHP);
		...
		try {
			...
			try {
				...
				try {
					...
					assertEquals("The HP of the hero attacked by a villain is not updated correctly. Expected " + expectedHP + " but was " + newHP + ".", newHP, expectedHP);
		...
		try {
			...
			try {
				...
				try {
					...
					assertEquals("The HP of the villain attacked by a villain is not updated correctly. Expected " + expectedHP + " but was " + newHP + ".", newHP, expectedHP);
		...
		try {
			...
			try {
				...
				try {
					...
					assertEquals("The HP of the antihero attacked by a villain is not updated correctly. Expected " + expectedHP + " but was " + newHP + ".", newHP, expectedHP);
		...
		try {
			...
			try {
				...
				try {
					...
					assertEquals("The HP of the hero attacked by an antihero is not updated correctly. Expected " + expectedHP + " but was " + newHP + ".", newHP, expectedHP);
		...
		try {
			...
			try {
				...
				try {
					...
					assertEquals("The HP of the  villain attacked by an antihero is not updated correctly. Expected " + expectedHP + " but was " + newHP + ".", newHP, expectedHP);
		...
		try {
			...
			try {
				...
				try {
					...
					assertEquals("The HP of the antihero attacked by an antihero is not updated correctly. Expected " + expectedHP + " but was " + newHP + ".", newHP, expectedHP);
		...
		try {
			...
			try {
				...
				try {
					...
					assertEquals("The HP of the attacked cover is not updated correctly. Expected " + expectedHP + " but was " + newHP + ".", newHP, expectedHP);
...
//										System.out.println("Champ 6 removed" + champ6);
			...
			try {
				...
				try {
					...
					try {
						...
						assertEquals("endTurn should update the duration of the champion's applied effects.", updatedDurationOne, (durationOne - 1));
						assertEquals("endTurn should update the duration of the champion's applied effects.", updatedDurationTwo, (durationTwo - 1));
						assertEquals("endTurn should update the duration of the champion's applied effects.", updatedDurationThree, (durationThree - 1));
	...
	public void applyLogicShieldBlockResources() {
		...
		try {
			...
			try {
				...
				fail(e.getCause() + " occurred while invoking \"attack\" method on an instance of \"Game\".");
	...
	private Object createPlayer(String s) {
		...
		} catch (NoSuchMethodException | SecurityException | ClassNotFoundException | InvocationTargetException |
	...
	private void testSetterLogicCover(Object createdObject, String name, Object setValue, Object expectedValue,
		...
		try {
			...
			fail("The type \"" + createdObject.getClass().getSimpleName()
